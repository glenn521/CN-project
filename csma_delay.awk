...
if ( event=="s" && node_nb== "_0_" && pkt_type=="tcp" && uid > highest_uid ) #&& trace_type=="MAC")
	{
		highest_uid = uid;
	}
	...
	if ( event=="s" && node_nb=="_0_" && pkt_type=="tcp" && uid==highest_uid) #&& trace_type=="MAC") # && pkt_size="44")
...
if ( event=="r" && node_nb=="_1_" && pkt_type=="tcp" && uid==highest_uid) #&& trace_type=="MAC") #&& pkt_size="38")
